 ...
 * The Negativity Developers 2011-2013
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("Negativity is infectious"));
#ifndef Q_WS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Negativity address"));
    ...
    aboutAction->setToolTip(tr("Show information about Negativity"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Negativity"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/toolbar"), tr("Show/Hide &Negativity"), this);
    toggleHideAction->setToolTip(tr("Show or hide the Negativity window"));
...
#ifndef Q_WS_MAC
            setWindowIcon(QIcon(":icons/Negativity_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/Negativity_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Negativity client"));
    ...
    notificator = new Notificator(tr("Negativity-qt"), trayIcon);
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Negativity network", "", count));
}
